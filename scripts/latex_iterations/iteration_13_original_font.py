...
# Tanjah Theme - Iteration 13 (Original Font with Minimalist Apple style)
...
% Reverting to standard LaTeX default font (Computer Modern Serif)
...
if __name__ == "__main__":
    ...
    # Removing fontupper=\sffamily to let the original serif font shine
    sample_options = r"""\begin{tcolorbox}[enhanced, colback=white, colframe=mainYellow, boxrule=0.3mm, leftrule=1.5mm, arc=1.5mm, drop fuzzy shadow=black!4!white]
\textbf{\textcolor{mainYellow!90!black}{A}}\hspace{0.3cm} $\displaystyle y=\int Qe^{\int pdx}dx+C$
\end{tcolorbox}
\begin{tcolorbox}[enhanced, colback=white, colframe=mainYellow, boxrule=0.3mm, leftrule=1.5mm, arc=1.5mm, drop fuzzy shadow=black!4!white]
\textbf{\textcolor{mainYellow!90!black}{B}}\hspace{0.3cm} $\displaystyle y=\int Qe^{-\int pdx}dx+C$
\end{tcolorbox}
\begin{tcolorbox}[enhanced, colback=white, colframe=mainYellow, boxrule=0.3mm, leftrule=1.5mm, arc=1.5mm, drop fuzzy shadow=black!4!white]
\textbf{\textcolor{mainYellow!90!black}{C}}\hspace{0.3cm} $\displaystyle ye^{\int pdx}=\int Qe^{\int pdx}dx+C$
\end{tcolorbox}
\begin{tcolorbox}[enhanced, colback=white, colframe=mainYellow, boxrule=0.3mm, leftrule=1.5mm, arc=1.5mm, drop fuzzy shadow=black!4!white]
\textbf{\textcolor{mainYellow!90!black}{D}}\hspace{0.3cm} $\displaystyle ye^{\int pdx}=\int Qe^{-\int pdx}dx+C$
\end{tcolorbox}"""
