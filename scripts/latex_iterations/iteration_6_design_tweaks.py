...
if __name__ == "__main__":
    output_img = "test_images/iteration_6_design.png"
    print(f"Attempting to render iteration 6 LaTeX to {output_img}...")

    # Sample Question Data
    sample_question = r"A 50 Hz, 4-pole induction motor runs at a speed of 1440 rpm. Calculate the slip of the motor."

    # Format options as individual tcolorboxes, removing the parenthesis
