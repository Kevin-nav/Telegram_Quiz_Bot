...
# Adjusting the border: {left bottom right top}
# Reverting to an even, small border around the content.
...
% We add 'overlay' so the large, rotated watermark doesn't stretch the bounding box!
\node[overlay, rotate=45, scale=5, opacity=0.08, color=black] at (content.center) {\textbf{Adarkwa}};
\end{tikzpicture}
\end{document}"""

if __name__ == "__main__":
    output_img = "test_images/iteration_4.png"
    print(f"Attempting to render iteration 4 LaTeX to {output_img}...")
