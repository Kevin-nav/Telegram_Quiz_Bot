...
# Tanjah Theme - Iteration 12 (Long LaTeX Test)
...
if __name__ == "__main__":
    output_img = "test_images/iteration_12_long_latex.png"
    print(f"Attempting to render iteration 12 LaTeX to {output_img}...")
    ...
    # Ensuring that the math fits inside nicely. The \displaystyle will help make the integrals look proper.
