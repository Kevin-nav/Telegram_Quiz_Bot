...
# Reduced left/right margin to 10pt to "crop in", increased bottom/top to 30pt for "little margin at the top and bottom"
TEMPLATE = r"""\documentclass[16pt, border={10pt 30pt 10pt 30pt}]{standalone}
...
if __name__ == "__main__":
    output_img = "test_images/iteration_3.png"
    print(f"Attempting to render iteration 3 LaTeX to {output_img}...")
