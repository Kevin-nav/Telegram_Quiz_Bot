...
# Note: requires 'pdf2image' installed, and poppler/pdflatex on the system
...
if __name__ == "__main__":
    ...
    print(f"Attempting to render test LaTeX to {output_img}...")

    # Sample Question Data
    sample_question = r"Calculate the integral of \( f(x) = x^2 \) from 0 to 3."
    sample_options = r"""\item 3
\item 6
\item 9
\item 12"""
    ...
    if success:
        print("Done! Check test_output.png")
    else:
